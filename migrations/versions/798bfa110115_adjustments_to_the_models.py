...
Revision ID: 798bfa110115
Revises: 9d8c4792aa03
Create Date: 2024-09-06 19:32:28.895166
...
def upgrade():
    ...
    with op.batch_alter_table('farms', schema=None) as batch_op:
        ...
        batch_op.alter_column('id',
               ...
               existing_server_default=sa.text("nextval('farms_id_seq'::regclass)"))
    ...
    with op.batch_alter_table('flocks', schema=None) as batch_op:
        ...
        batch_op.alter_column('id',
               ...
               type_=sa.UUID(),
               existing_nullable=False,
               existing_server_default=sa.text("nextval('flocks_id_seq'::regclass)"))
    ...
    with op.batch_alter_table('production', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('farm_id', sa.UUID(), nullable=False))
        batch_op.add_column(sa.Column('created_at', sa.DateTime(), nullable=False))
        batch_op.add_column(sa.Column('updated_at', sa.DateTime(), nullable=False))
